...
import usbong.android.ping_pong.R;
import usbong.android.ping_pong.UsbongDecisionTreeEngineActivity;
...
public class UsbongUtils {		
	...
	public static String DEFAULT_UTREE_TO_LOAD="ping_pong"; //updated by Mike, 20160720
	public static String BASE_FILE_PATH = Environment.getExternalStorageDirectory()+"/usbong_ping_pong/";
	...
	public final static String myPackageName="usbong.android.ping_pong";
	public static String myAppTreeFolder = "/usbong_ping_pong/usbong_trees/";
