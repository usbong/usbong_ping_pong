...
*/    
    ...
    public static final String ALL_LANGUAGES_PRODUCT_ID = "usbong.ping_pong.all_languages_001"; //added by Mike, 20160620
    public static final String ALL_LOCAL_LANGUAGES_PRODUCT_ID = "usbong.ping_pong.all_local_languages_001";
    public static final String ALL_FOREIGN_LANGUAGES_PRODUCT_ID = "usbong.ping_pong.all_foreign_languages_001";
